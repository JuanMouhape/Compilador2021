...
public final static short Sentencias_declarativas=284;
public final static short Bloque_sentencias_ejecutables=285;
public final static short Lista_variables=286;
public final static short Tipo=287;
public final static short Condicion=288;
public final static short Expresion=289;
...
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,
null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,
null,null,null,null,null,"ID","CTE","IF","ELSE","ENDIF","PRINT","THEN","BEGIN",
"END","LONG","SINGLE","RETURN","FUNC","CADENA","ERROR","BREAK","MAYOR_IGUAL",
"MENOR_IGUAL","IGUAL","DISTINTO","ASIGN","REPEAT","AND","OR","POST","TRY",
"CATCH","Sentencias_declarativas","Bloque_sentencias_ejecutables",
"Lista_variables","Tipo","Condicion","Expresion",
};
...
"Declaracion_funcion : Tipo FUNC ID '(' Parametro ')' Sentencias_declarativas BEGIN Bloque_sentencias_ejecutables RETURN '(' Retorno ')' POST ':' '(' Condicion ')' ';' END",
"Retorno : Expresion",
"Parametro : Tipo ID",
};

//#line 36 "gramaticaCopia.y"
...
case 1:
//#line 15 "gramaticaCopia.y"
{salida.add("Linea - "+ (aLexico.getContadorFila()+1)+" - Programa aceptado.");}
break;
case 4:
//#line 24 "gramaticaCopia.y"
{salida.add("Linea - "+ (aLexico.getContadorFila()+1)+" - Declaracion de funciones. ");}
break;
case 5:
//#line 25 "gramaticaCopia.y"
{salida.add("Linea - "+ (aLexico.getContadorFila()+1)+" - Declaracion de funciones con POST. ");}
break;
